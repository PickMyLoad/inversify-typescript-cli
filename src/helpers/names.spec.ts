...
describe('names', () => {
  ...
  it('should return correct casing', () => {
    ...
    expect(names.getModuleVarName('Sub/Hi')).to.eql('hi');
    ...
    expect(names.getComponentClassName('Sub/hi')).to.eql('Hi');
    expect(names.getComponentInterfaceName('hi')).to.eql('IHi');
    expect(names.getComponentInterfaceName('Sub/hi')).to.eql('IHi');
